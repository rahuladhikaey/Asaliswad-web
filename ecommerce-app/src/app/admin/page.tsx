                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start gap-6 mb-8 pb-8 border-b border-slate-100">
                      ...
                      <div className="flex flex-col items-start lg:items-end gap-3 w-full lg:w-auto">
                        <div className="flex flex-wrap justify-start lg:justify-end gap-2">
                          <span className={`px-4 py-2 rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] shadow-sm ${order.payment_method === 'COD'
                              ? 'bg-amber-100 text-amber-700 border border-amber-200'
                              : 'bg-blue-100 text-blue-700 border border-blue-200'
                            }`}>
                            {order.payment_method || 'N/A'}
                          </span>
                          <span className={`px-4 py-2 rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] shadow-sm ${order.payment_status === 'COMPLETE'
                              ? 'bg-emerald-50 text-emerald-600 border border-emerald-100'
                              : 'bg-rose-50 text-rose-600 border border-rose-100'
                            }`}>
                            {order.payment_status || 'PENDING'}
                          </span>
                          <span className={`px-4 py-2 rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] shadow-sm ${order.order_status === 'DELIVERED'
                    ...
                    <div className="grid md:grid-cols-[1fr_auto] gap-8">
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <div className="bg-slate-900 rounded-[2rem] p-4 sm:p-6 text-slate-300 shadow-xl shadow-slate-900/10 text-[10px] sm:text-xs leading-relaxed font-mono">
